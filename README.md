...
```javascript
isNegativeNumber = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-negative-number@v0.2.2-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-negative-number@v0.2.2-umd/browser.js"></script>
```
